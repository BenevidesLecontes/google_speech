...
class RecognitionConfig_AudioEncoding extends $pb.ProtobufEnum {
  ...
  static const RecognitionConfig_AudioEncoding ALAW =
      RecognitionConfig_AudioEncoding._(10, _omitEnumNames ? '' : 'ALAW');
  ...
  const RecognitionConfig_AudioEncoding._(super.v, super.n);
}
...
class RecognitionMetadata_InteractionType extends $pb.ProtobufEnum {
  ...
  const RecognitionMetadata_InteractionType._(super.v, super.n);
}
...
class RecognitionMetadata_MicrophoneDistance extends $pb.ProtobufEnum {
  ...
  const RecognitionMetadata_MicrophoneDistance._(super.v, super.n);
}
...
class RecognitionMetadata_OriginalMediaType extends $pb.ProtobufEnum {
  ...
  const RecognitionMetadata_OriginalMediaType._(super.v, super.n);
}
...
class RecognitionMetadata_RecordingDeviceType extends $pb.ProtobufEnum {
  ...
  const RecognitionMetadata_RecordingDeviceType._(super.v, super.n);
}
