...
class RecognitionConfig extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOB(16, _omitFieldNames ? '' : 'enableSpeakerDiarization')
    ..a<$core.int>(17, _omitFieldNames ? '' : 'diarizationSpeakerCount',
        $pb.PbFieldType.O3)
  ...
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(16)
  void clearEnableSpeakerDiarization() => $_clearField(16);
  ...
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(17)
  void clearDiarizationSpeakerCount() => $_clearField(17);
  ...
  /// transcription).
  @$pb.TagNumber(18)
  $pb.PbList<$core.String> get alternativeLanguageCodes => $_getList(16);
  ...
  @$pb.TagNumber(20)
  $4.SpeechAdaptation get adaptation => $_getN(18);
  @$pb.TagNumber(20)
  ...
  @$pb.TagNumber(20)
  $4.SpeechAdaptation ensureAdaptation() => $_ensure(18);
  ...
  @$pb.TagNumber(22)
  $core.bool hasEnableSpokenPunctuation() => $_has(19);
  @$pb.TagNumber(22)
  void clearEnableSpokenPunctuation() => $_clearField(22);
  @$pb.TagNumber(22)
  $5.BoolValue ensureEnableSpokenPunctuation() => $_ensure(19);
  ...
  @$pb.TagNumber(23)
  $core.bool hasEnableSpokenEmojis() => $_has(20);
  @$pb.TagNumber(23)
  void clearEnableSpokenEmojis() => $_clearField(23);
  @$pb.TagNumber(23)
  $5.BoolValue ensureEnableSpokenEmojis() => $_ensure(20);
  ...
  @$pb.TagNumber(24)
  $4.TranscriptNormalization get transcriptNormalization => $_getN(21);
  @$pb.TagNumber(24)
  ...
  @$pb.TagNumber(24)
  $core.bool hasTranscriptNormalization() => $_has(21);
  @$pb.TagNumber(24)
  void clearTranscriptNormalization() => $_clearField(24);
  @$pb.TagNumber(24)
  $4.TranscriptNormalization ensureTranscriptNormalization() => $_ensure(21);
}
...
class RecognitionMetadata extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aInt64(9, _omitFieldNames ? '' : 'obfuscatedId')
  ...
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(9)
  void clearObfuscatedId() => $_clearField(9);
...
class RecognizeResponse extends $pb.GeneratedMessage {
  factory RecognizeResponse({
    ...
    if (usingLegacyModels != null) {
      $result.usingLegacyModels = usingLegacyModels;
    }
    return $result;
  }
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOB(9, _omitFieldNames ? '' : 'usingLegacyModels')
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(9)
  $core.bool get usingLegacyModels => $_getBF(4);
  @$pb.TagNumber(9)
  set usingLegacyModels($core.bool v) {
    $_setBool(4, v);
  }

  @$pb.TagNumber(9)
  $core.bool hasUsingLegacyModels() => $_has(4);
  @$pb.TagNumber(9)
  void clearUsingLegacyModels() => $_clearField(9);
}
...
class LongRunningRecognizeMetadata extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<TranscriptOutputConfig>(5, _omitFieldNames ? '' : 'outputConfig',
        subBuilder: TranscriptOutputConfig.create)
    ..hasRequiredFields = false;
  ...
  /// request.
  @$pb.TagNumber(5)
  TranscriptOutputConfig get outputConfig => $_getN(4);
  @$pb.TagNumber(5)
  set outputConfig(TranscriptOutputConfig v) {
    $_setField(5, v);
  }
  ...
  @$pb.TagNumber(5)
  void clearOutputConfig() => $_clearField(5);
  @$pb.TagNumber(5)
  TranscriptOutputConfig ensureOutputConfig() => $_ensure(4);
}
